<?php 
	...
	if ($sql=mysqli_query($conn, "INSERT into subjects (CODE, `SUBJECT`, `DESCRIPTION`) 
		VALUES ( '$sub','$for', '$des')")){
	...
	setTimeout(function(){	window.location.href='rms.php?page=subjects';  }, 2000);</script>";
		...
		$id=$_POST['id'];
		$sql = "UPDATE subjects SET CODE='$sub',SUBJECT='$des',DESCRIPTION='$for' WHERE SUBJECT_ID='$id'";
