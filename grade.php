          ...
          <h3 class="page-header">Niveau <small>section</small></h3> 
      <?php
       ...
       <div class="col-md-8 " id="s_page">
        ...
        <div class="panel-heading">
          <h3 class="panel-title">Liste des Niveau</h3>
        </div> 
  ...
  <table id="students" class="table table-hover table-bordered">
    ...
    ?>
      ...
      <tr>
        ...
        <td><center><a onclick="update_grade(<?php echo $row["grade_id"]?>)" class="btn btn-info" ><i class="fa fa-pencil-square" aria-hidden="true"></i> Ecrire</a></center></td>
      </tr>
  ...
  function update_grade($i){
   var i = $i;
      ...
      <div class="row main">
        ...
        <h3 id="head">Ajouter un niveau</h3>
          <form class="" method="post">
            <input type="hidden" id="id" name="id">
            <div class="form-group">
              <label for="grade" class="cols-sm-2 control-label">Niveau</label>
              <div class="cols-sm-4">
