...
<head>
    ...
    <title>Système de résultats des étudiants</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href=""><b>&nbsp;&nbsp;&nbsp; Système de gestion des résultats des étudiants</b></a>
            </div>
            <!-- Top Menu Items -->
            ...
            if($row['USER_TYPE'] == 'ADMINISTRATOR'){
                ?>
                    <li>
                         <a href="" data-toggle="modal" data-target="#new_user"><i class="fa fa-fw fa-pencil"></i>Compte</a>
                    </li>
                   <li class="divider"></li>
                   <?php
                   }else{}
            ...
            $sql = mysqli_query($conn,"SELECT * FROM student_info where STUDENT_ID = '".$_SESSION['STUDENT_ID']."'");
            $row = mysqli_fetch_assoc($sql);
...
?>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Gestion du compte</h4>
        </div>
    ...
    ?>
      ...
      <label class="control-label col-sm-1" for="fname">Prénom(s):</label>
      <div class="col-sm-3">  
    ...
    <div class="form-group">
      <label class="control-label col-sm-1" for="lname">Nom(s):</label>
      <div class="col-sm-3">          
        <input type="text" class="form-control" id="lname" name="lname" value="<?php echo $row['LASTNAME'] ?>" >
      </div>
    </div>  
    <div class="form-group">
      <label class="control-label col-sm-1" for="user">Nom utilisateur:</label>
      <div class="col-sm-3">          
    ...
    <div class="form-group">
      <label class="control-label col-sm-1" for="pwd">Type utilisateur:</label>
      <div class="col-sm-3">   
    ...
    <?php } ?>
    <div class="form-group">
      <label class="control-label col-sm-1" for="admin">Mot de passe courant</label>
      <div class="col-sm-3">          
